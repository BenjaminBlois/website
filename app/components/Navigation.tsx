        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center space-x-6 xl:space-x-8">
            <div className="relative group">
              <Link href="/services" className="text-black hover:text-[#306BAC] font-semibold transition-colors text-sm xl:text-base flex items-center gap-1 no-underline">
                Services
              ...
              <div className="absolute left-0 mt-2 w-48 bg-white rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <Link href="/services/individual" className="block px-4 py-3 text-sm text-black hover:bg-[#98B9F2]/10 hover:text-[#306BAC] no-underline rounded-t-lg">
                  Personal
                </Link>
                <Link href="/services/business" className="block px-4 py-3 text-sm text-black hover:bg-[#98B9F2]/10 hover:text-[#306BAC] no-underline rounded-b-lg">
                  Business
                </Link>
              </div>
            </div>
            <Link href="/about" className="text-black hover:text-[#306BAC] font-semibold transition-colors text-sm xl:text-base no-underline">
              About
            </Link>
            <Link href="/pricing" className="text-black hover:text-[#306BAC] font-semibold transition-colors text-sm xl:text-base no-underline">
              Pricing
            </Link>
            <Link href="/login" className="text-black hover:text-[#306BAC] font-semibold transition-colors text-sm xl:text-base no-underline">
              Sign In
            </Link>
            <button
